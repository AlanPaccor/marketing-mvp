            ...
            <div className="flex items-center space-x-4">
              <div className="relative w-16 h-16 rounded-full overflow-hidden bg-indigo-100 flex items-center justify-center">
                {profileImage ? (
                  <Image 
                    src={profileImage} 
                    alt={profile?.full_name || 'Influencer Profile'} 
                    width={64}
                    height={64}
                  ...
                  <span className="text-2xl font-semibold text-indigo-700">
                    {profile?.full_name?.charAt(0)?.toUpperCase() || user?.email?.charAt(0)?.toUpperCase() || 'I'}
                  </span>
                )}
              </div>
              <div>
                ...
                <div className="flex items-center">
                  <p className="text-sm text-gray-500">{profile?.platform || 'Platform'}</p>
                  {profile?.followers && (
                    <>
